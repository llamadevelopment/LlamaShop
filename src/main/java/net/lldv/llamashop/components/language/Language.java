package net.lldv.llamashop.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        LlamaShop.getInstance().saveResource("messages.yml");
        Config m = new Config(LlamaShop.getInstance().getDataFolder() + "/messages.yml");
